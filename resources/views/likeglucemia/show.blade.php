        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                {{-- @if ($user->id === auth()->user()->id)  --}}
                    <div class="flex flex-col md:flex-row md:justify-around items-center md:my-7">
                        <div class="p-6 text-gray-900 font-bold dark:text-gray-100 flex md:flex-row gap-2">
                        ...
                        {{-- @if ($user->id === auth()->user()->id)
                            ...
                            <div>
                                <a href="{{ route('glucemias.show', $user) }}" class="bg-indigo-500 hover:bg-indigo-700 text-white px-3 md:px-5 py-2 rounded uppercase font-semibold cursor-pointer flex justify-between items-center gap-2">
                ...
                <div class="flex flex-col md:flex-row md:justify-around mt-5 md:mt-0">
                    <div class="md:w-5/12 p-2">
                        <livewire:ver-like-glucemia
                            :glucemia="$glucemia"
                            :user="$user"
                        />
                    </div>
