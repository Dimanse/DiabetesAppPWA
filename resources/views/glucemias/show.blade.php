                ...
                {{-- @if ($user->id === auth()->user()->id)  --}}
                    <div class="flex flex-col md:flex-row md:justify-around items-center md:mt-7">
                        <div class="p-6 text-gray-900 font-bold dark:text-gray-100 flex md:flex-row gap-2">
                            ...
                            <a href="{{ route('usuarios.index') }}" class="bg-indigo-500 hover:bg-indigo-700 text-white px-3 md:px-5 py-2 rounded uppercase font-semibold cursor-pointer flex justify-between items-center gap-2">
