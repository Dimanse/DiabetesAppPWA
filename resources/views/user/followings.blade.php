                                        ...
                                        @foreach ($followings as $following )
                                            <tr class="even:bg-slate-100" >
                                                <td class=" py-3 flex justify-center " >
                                                    <img src="{{ asset('storage/imagenes') . '/' . $following->historia->imagen }} " alt="imagen del usuario" class="rounded-full w-16 md:w-20">
                                                </td>

                                                <td class=" py-3  text-center " >
                                                        <p class="text-sky-600 font-bold md:text-lg">{{$following->historia->nombre}}</p>
                                                        <span class="text-xs block">{{$following->created_at->diffForHumans()}}</span>
                                                </td>
